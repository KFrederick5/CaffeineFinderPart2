...
public class CaffeineListActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private static int FINE_LOCATION_REQUEST_CODE = 100;
    ...
    private void handleNewLocation(Location location)
    {
        ...
        CameraPosition cameraPosition = new
                CameraPosition.Builder().target(myCoordinate).zoom(14.0f).build();
    ...
    {
        LatLng coordinate = new LatLng(caffeineLocation.getLatitude(),
                caffeineLocation.getLongitude());
        mMap.addMarker(new MarkerOptions().position(coordinate)
        .title(caffeineLocation.getName()));
    ...
    public void findClosestCaffeine(View v)
    {
        ...
        detailsIntent.putExtra("ClosestCaffieneLocation", closestCaffeineLocation);
